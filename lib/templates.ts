...
function buildElderlyCentreTemplate(params: Record<string, string | number>): PitstopTemplate[] {
  ...
  const monthlyReview: PitstopTemplate = {
    ...
    checklist: [
      ...
      { text: "Issue tracker active" },
      { text: "Corrective actions followed up" },
      { text: "Learnings converted to actions" },
    ],
  };
    ...
    return [
      monthlyReview,
      {
        ...
        checklist: [
          ...
          { text: "Home visits active" },
          { text: "Referral systems active" },
          { text: "Forums started" },
          { text: "MIS reporting active in all clusters" },
        ],
      },
    ];
  }
  ...
  return [
    {
      ...
      slaDays: 14,
      checklist: [
        { text: "Implementing partner roles clarified" },
        { text: "Technical partner coordination structure clarified" },
        { text: "Cluster ownership mapped" },
        { text: "Rollout roadmap shared" },
      ],
    },
    {
      ...
      checklist: [
        { text: "JDs circulated" },
        { text: "Partner recruitment substantially completed" },
        { text: "Technical partner staffing available" },
        { text: "Cluster deployment completed" },
        { text: "Reporting lines clear" },
      ],
    },
    {
      ...
      slaDays: 45,
      checklist: [
        { text: "Elder profile module ready" },
        { text: "Assessment form live" },
        { text: "Dashboards active" },
        { text: "Monthly reporting format available" },
      ],
    },
    {
      ...
      slaDays: 45,
      checklist: [
        { text: "Assessment tools ready" },
        { text: "Categorisation logic available" },
        { text: "Visit formats ready" },
        { text: "First SOP pack shared" },
      ],
    },
    {
      ...
      slaDays: 60,
      checklist: [
        { text: "Exposure visits completed", activityTitle: "Staff Exposure Visit" },
        { text: "Orientation sessions completed" },
        { text: "Field familiarisation completed" },
        { text: "Learnings documented" },
      ],
    },
    {
      ...
      checklist: [
        ...
        { text: "Field bottlenecks reviewed" },
        { text: "Tool refinements completed" },
        { text: "Full rollout ready" },
      ],
    },
    {
      ...
      slaDays: 90,
      checklist: [
        { text: "Assessments started in all clusters" },
        { text: "Daily progress monitoring active" },
        { text: "Productivity tracking active" },
      ],
    },
    {
      ...
      slaDays: 105,
      checklist: [
        { text: "Coverage targets reached" },
        { text: "Pending assessments minimized" },
        { text: "Data cleaned" },
        { text: "Final usable dataset available" },
      ],
    },
    {
      ...
      slaDays: 120,
      checklist: [
        { text: "Elders segmented by need level" },
        { text: "Priority elderly flagged" },
        { text: "Initial care plans assigned" },
      ],
    },
    {
      ...
      slaDays: 135,
      checklist: [
        { text: "Visit frequency norms defined" },
        { text: "Worker allocation completed" },
        { text: "Home visit tracking active" },
        { text: "Escalation pathway functioning" },
      ],
    },
    {
      ...
      checklist: [
        ...
        { text: "Service directory created" },
        { text: "Referral contacts listed" },
        { text: "Pathways documented" },
      ],
    },
    {
      ...
      slaDays: 140,
      checklist: [
        { text: "Priority referrals started" },
        { text: "Follow-up system active" },
        { text: "Crisis response pathway active" },
      ],
    },
    {
      ...
      slaDays: 120,
      checklist: [
        { text: "Need-based clusters identified" },
        { text: "Sites shortlisted" },
        { text: "Feasibility completed" },
        { text: "Rollout plan prepared" },
      ],
    },
    {
      ...
      slaDays: 135,
      checklist: [
        { text: "Staff identified" },
        { text: "Basic infrastructure ready" },
        { text: "Equipment arranged" },
        { text: "Staff oriented", activityTitle: "Day Care Staff Orientation" },
      ],
    },
    {
    ...
    },
    {
      ...
      slaDays: 130,
      checklist: [
        { text: "Forum model finalized" },
        { text: "Training materials ready" },
        { text: "Member mobilisation plan ready" },
      ],
    },
    {
      ...
      slaDays: 150,
      checklist: [
        { text: "Initial forums formed", activityTitle: "Elder Forum Formation Meeting" },
        { text: "Facilitators identified" },
        { text: "Meeting rhythm started" },
      ],
    },
    {
      ...
      checklist: [
        ...
        { text: "Initial groups formed" },
        { text: "Volunteer support initiated" },
      ],
    },
    {
      ...
      slaDays: 160,
      checklist: [
        { text: "Day care manual updated" },
        { text: "Community care SOP updated" },
        { text: "Referral protocols documented" },
        { text: "Practice notes issued" },
      ],
    },
    monthlyReview,
    {
