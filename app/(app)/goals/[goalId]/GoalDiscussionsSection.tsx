...
import { MessageSquare, Megaphone, ChevronDown, ChevronRight, Plus, Send, X, Bell, BellOff, Paperclip, Trash2 } from "lucide-react";
        ...
        {!activeThread ? (
          ...
          <>
            ...
            <div className="px-3 py-3 border-t border-stone-100 flex-shrink-0">
              <MessageComposer threadId={activeThread.id} users={users} onSent={msg => handleMsg(activeThread.id, msg as Message)} />
            </div>
          </>
        )}
      </div>
