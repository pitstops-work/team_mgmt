          ...
          <div className="space-y-2">
            {items.map((t) => (
              ...
              >
                ...
                <Link
                  href={`/settings/templates/new?copy=${t.id}`}
                  className="p-1.5 -mr-1 text-stone-300 hover:text-sky-600 hover:bg-sky-50 rounded transition-colors flex-shrink-0"
                  title="Duplicate this template into a new draft"
