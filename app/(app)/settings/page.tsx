...
import { Copy, Check, RefreshCw, Users, KeyRound, CalendarDays, Target, ChevronRight, ShieldCheck, Map } from "lucide-react";
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
      ...
      {isAdmin && (
        <section className="mb-10">
          ...
          <p className="text-xs text-stone-500 mb-3">Manage user accounts and geography — only visible to you.</p>
