        ...
        <div className="bg-white rounded-2xl border border-stone-200 shadow-sm p-6">
          ...
          {iosStandalone ? (
            <p className="mt-4 text-center text-xs text-stone-500 leading-relaxed">
              Google sign-in doesn&apos;t work inside the home-screen app on iPad.
              Use email and password above, or open{" "}
              <span className="font-medium text-stone-700">pitstops.work</span>{" "}
              in Safari to sign in with Google.
            </p>
          ) : (
            <button
              type="button"
