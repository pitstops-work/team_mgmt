...
async function main() {
  ...
  const newNodes = [
    ...
    { groupId: capacity.id, key: "facility_open_hours", label: "Complex open hours", dataType: "number", defaultJson: 16, unit: "hours/day", notes: "Toilet/bath/laundry only serve while open (from 6am); closed-hour demand shifts into the open window", surface: "both", tier: "basic", uiJson: { min: 6, max: 24, step: 1 }, order: 909 },
