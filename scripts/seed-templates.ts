...
const entries: SeedEntry[] = [
  ...
  },
  {
    ...
    pitstops: build("elderly-centre", { track: "new", centres: 1 }),
  },
  {
    slug: "elderly-centre-existing",
    name: "Elderly Care Centre & Outreach (Existing)",
    description: "Monthly monitoring pitstops for an existing elderly care centre.",
    category: "Community Programs",
    icon: "🏥",
    needsDomain: null,
    sortOrder: 12,
    parameters: withoutParam(getTemplate("elderly-centre").parameters, "track"),
    pitstops: build("elderly-centre", { track: "existing", centres: 1 }),
  },
  {
