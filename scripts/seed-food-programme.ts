    ...
    [
      ...
      },
      {
        ...
        checklist: [
          ...
          { text: "JustDelivery backup retainer signed and on file", activityTitle: "JustDelivery Retainer Meeting", completionType: "Activity" },
      ...
      },
      {
        ...
        checklist: [
          ...
          { text: "DP 5 (shelter) — driver serves directly, no separate DP personnel needed" },
    ...
    [
      ...
      },
      {
        ...
        checklist: [
          ...
          { text: "Insulated containers checked — temperature retention adequate" },
    ...
    [
      {
        ...
        checklist: [
          ...
          { text: "TATA Ace access and parking confirmed — route driveable from existing stops" },
      ...
      },
      {
        ...
        checklist: [
          ...
          { text: "Vehicle bay layout updated — new kit confirmed to fit" },
        ],
      },
      {
